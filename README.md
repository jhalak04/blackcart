...
<b>Create new project in laravel</b>
```
composer create-project --prefer-dist laravel/laravel blog
```

<b>Update .env file with below code</b>
...
<b>Run Laravel project on local server</b>
...
<b>Run PHP Unit test</b>

```
./vendor/bin/phpunit
```

<b>API will be run using the following link</b>

```
http://localhost:8001/api/stores
```

<b>Files to refer code : </b>

- StoreController.php > blackcart/app/Http/Controllers/StoresController.php
- Stores.php > blackcart/app/Stores.php
